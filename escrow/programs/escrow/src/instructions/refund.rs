...
pub struct Refund<'info> {
    ...
    // this mint account specifying the type of token to be sent
    #[account(
    ...
    // Without has_one, someone could pass in a valid escrow account with mismatched fields, and potentially steal tokens or mess with logic.
